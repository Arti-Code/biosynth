...
pub const AGENTS_NUM: usize = 72;
pub const AGENTS_NUM_MIN: usize = 64;
...
pub const PARTICLES_NUM: i32 = 0;
pub const PARTICLE_POS_INFO: bool = true;
pub const FIELD_RADIUS: f32 = 256.0;
...
pub const PLANT_MAX_SIZE: i32 = 11;
