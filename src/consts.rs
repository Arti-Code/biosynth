...
pub const AGENTS_NUM: usize = 5;
pub const AGENTS_NUM_MIN: usize = 20;
pub const AGENT_SIZE_MIN: i32 = 12;
pub const AGENT_SIZE_MAX: i32 = 26;
pub const AGENT_SPEED: f32 = 100.0;
pub const AGENT_VISION_RANGE: f32 = 240.0;
pub const AGENT_ROTATE: f32 = 2.0;
